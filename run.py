...
Execute the full analytics pipeline, notebook by notebook, in order.
    ...
    python run.py                  run every notebook
    python run.py --from 03        resume from notebook 03
    python run.py --only 06 08     run just those notebooks
    python run.py --checkpoint1    notebooks 01 to 04 only
    python run.py --list           show the pipeline without running it
